...
class NovalnetAssistant extends WizardProvider
{
    ...
    */
    ...
    {
         $onHoldSupportedPayments = ['novalnetSepa', 'novalnetCc', 'novalnetInvoice', 'novalnetGuaranteedInvoice', 'novalnetGuaranteedSepa', 'novalnetInstalmentInvoice', 'novalnetInstalmentSepa', 'novalnetPaypal', 'novalnetApplepay', 'novalnetGooglepay'];
