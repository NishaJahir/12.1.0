        ...
        jQuery('#nn_instalment_cycle').on('change',function() {             
            ...
            for(instalmentCycle = 1; instalmentCycle <= jQuery(this).val(); instalmentCycle++) {
                if(instalmentCycle != jQuery(this).val())
                {
                    ...
                    var lastCycleAmount = (jQuery('#nn_instalment_order_amount').val() - (jQuery(this).find(':selected').attr('data-cycle-amount') * (jQuery(this).val() - 1)));
                    cycleInformation += '<tr><td>' + instalmentCycle + '</td><td>'+ formatMoney(lastCycleAmount) + ' '+ jQuery('#nn_instalment_order_currency').val()+'</td></tr>';
                }
            }                           
